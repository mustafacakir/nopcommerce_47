...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    title: 'Derneğiniz İçin Online Sadaka Platformu Nasıl Kurulur?',
    desc: 'Hayırseverlere güvenli ve kolay bir sadaka deneyimi sunmak için bilmeniz gerekenler.',
    readTime: '5 dk',
    img: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600&q=80',
    content: [
      { type: 'p', text: 'Türkiye\'de dernek ve vakıfların dijitalleşmesi hız kazandı. Hayırseverler artık kapıdan kapıya bağış toplanmasını beklemiyor; güvenilir bir web sayfası üzerinden, istedikleri anda sadakalarını ulaştırmak istiyor.' },
      { type: 'h2', text: 'Online Sadaka Platformunun Temelleri' },
      { type: 'p', text: 'İyi bir sadaka platformu üç temel unsuru bir araya getirir: güvenli ödeme altyapısı, sadakanın nereye gittiğini gösteren şeffaf raporlama ve hayırseverle kurulan düzenli iletişim. Bu üçünü bir arada sağlayan platformlar, hayırseverin derneğe olan güvenini pekiştirir.' },
      { type: 'h2', text: 'Güvenli Ödeme Entegrasyonu' },
      { type: 'p', text: 'Hayırseverlerin en sık sorduğu soru "param gerçekten derneğe ulaşıyor mu?" sorusudur. BDDK lisanslı ödeme kuruluşları üzerinden alınan sadakalar hem yasal düzenlemelere uygun hem de güvenlidir. Otomatik makbuz bu güveni tescilleyen en önemli unsurdur.' },
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'Kurban ibadeti, İslam\'ın en güzel şiarlarından biridir. Dernek ve vakıflar her yıl bu mübarek ibadetin organizasyonunu yürütür: hisse talepleri, ödeme takibi, kesimhane koordinasyonu ve bildirimler. Tüm bu süreçler dijital bir platformla hem eksiksiz hem de çok daha hızlı yönetilebilir.' },
      { type: 'h2', text: 'Online Hisse Talebi ve Ödeme' },
      { type: 'p', text: 'Hayırseverler kurban hisselerini web siteniz üzerinden seçip güvenli şekilde ödeyebilir. Büyükbaş veya küçükbaş seçimi, hisse adedi ve kesim yeri tercihi formda toplanır. Ödeme tamamlandığında otomatik makbuz hayırsevere iletilir.' },
      { type: 'h2', text: 'Hisse Takip Sistemi' },
      { type: 'p', text: 'Her hayırsevere benzersiz bir hisse kodu atanır. Kurban kesildiğinde sistem otomatik SMS veya WhatsApp bildirimi gönderir. "Kurbanım kesildi mi?" soruları ekibinize ulaşmadan önce sistem yanıtlamış olur.' },
      { type: 'h2', text: 'Raporlama ve Şeffaflık' },
      { type: 'p', text: 'Kaç hisse alındı, hangi kesimhanede kaç kurban kesildi, toplanan sadaka miktarı — tüm bu veriler anlık olarak panelde görünür. Yönetim kuruluna ve hayırseverlere şeffaf rapor paylaşımı tek tıkla yapılır.' },
      { type: 'p', text: 'Pekin Teknoloji kurban organizasyon modülü, küçük derneklerden büyük vakıflara bu mübarek ibadetin eksiksiz yönetilmesini sağlar. Kurulum birkaç gün sürer, kurban bayramı öncesinde yayına alabilirsiniz.' },
    ],
  },
  {
    slug: 'dernek-bagis-sistemi',
    tag: 'Dernek', color: '#16a34a',
    title: 'Dernek Sadaka Sistemi: Dijital Altyapıyı Doğru Kurmak',
    desc: 'Hangi bileşenler gerekir, güvenli ödeme nasıl çalışır, hayırseverle iletişim nasıl kurulur?',
    readTime: '6 dk',
    img: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=600&q=80',
    content: [
      { type: 'p', text: 'Türkiye\'de dernek ve vakıfların hayır faaliyetlerini dijitale taşıması artık bir tercih değil, zorunluluk. Hayırseverler telefonu elinde, istedikleri anda güvenilir bir platforma sadakalarını ulaştırmak istiyor. Doğru kurulmuş bir dernek sadaka sistemi bu beklentiyi karşılar ve hayırsever ile dernek arasındaki köprüyü güçlendirir.' },
      { type: 'h2', text: 'Sadaka Sisteminin Temel Bileşenleri' },
      { type: 'p', text: 'İşlevsel bir dernek sadaka sistemi dört katmandan oluşur: kampanya yönetimi (hedef, ilerleme, süre), güvenli ödeme altyapısı (sanal pos, 3D Secure), otomatik makbuz düzenleme ve hayırsever iletişimi (e-posta, WhatsApp bildirimleri). Bu dört bileşen birlikte çalışmadığında her eksiği insan emeğiyle kapatmak gerekir.' },
      { type: 'h2', text: 'Güvenli Ödeme Entegrasyonu' },
      { type: 'p', text: 'BDDK lisanslı ödeme kuruluşları üzerinden alınan sadakalar hem yasal hem güvenlidir. Hayırsever sayfada kart bilgisini girer, 3D Secure ile kimliğini doğrular ve saniyeler içinde onay alır. Kart bilgileri hiçbir zaman derneğin sunucusunda saklanmaz; bu, hayırseverin emanetini en iyi koruyan güvencedir.' },
      { type: 'h2', text: 'Otomatik Makbuz ve Yasal Uyumluluk' },
      { type: 'p', text: 'Dernekler Kanunu kapsamında yapılan her bağış için makbuz düzenlenmesi zorunludur. İyi bir sadaka sistemi bunu otomatik yapar: ödeme tamamlandığı anda hayırsevere PDF makbuz e-posta ile iletilir. Manuel makbuz kesmek hem zaman kaybı hem hata riskidir.' },
  ...
  {
    slug: 'online-kurban-organizasyonu',
    tag: 'Dernek', color: '#b45309',
    title: 'Online Kurban Organizasyonu: Hisseden Kesime Şeffaf Yönetim',
    desc: 'Hisse talebi, ödeme takibi, hisse kodu ve kesim bildirimi — İslami ibadetin eksiksiz dijital yönetimi.',
    readTime: '5 dk',
    img: 'https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=600&q=80',
    content: [
      { type: 'p', text: 'Kurban Bayramı, Müslümanlar için en kıymetli ibadet günlerinden biridir. Her yıl dernek ve vakıflar bu mübarek ibadetin organizasyonunu üstlenir: hisse talepleri, ödeme takibi, kesimhane koordinasyonu ve bildirimler. Tüm bu süreçler kâğıt ve telefonla yürütüldüğünde hatalar ve gecikmelere yol açar. Online kurban yönetimi bu sorumluluğun hakkıyla yerine getirilmesini sağlar.' },
      { type: 'h2', text: 'Online Hisse Talebi Nasıl Çalışır?' },
      { type: 'p', text: 'Hayırseverler web sitenizdeki kurban sayfasına girerek büyükbaş veya küçükbaş seçer, hisse adedini belirler ve güvenli ödeme altyapısıyla işlemi tamamlar. Ödeme onaylandığı anda otomatik makbuz ve benzersiz hisse kodu hayırsevere iletilir. Ekibiniz yoğunluğa boğulmadan yüzlerce hayırseverin talebini eksiksiz kaydeder.' },
      { type: 'h2', text: 'Hisse Kodu ile Şeffaf Takip' },
      { type: 'p', text: 'Her hayırsevere atanan hisse kodu, kurban sürecinin şeffaflığını sağlar. Hayırsever bu kod ile hissesinin durumunu anlık olarak takip edebilir. "Kurbanım kesildi mi?" sorusu, sistem cevaplamadan önce ekibinize ulaşmaz.' },
      { type: 'h2', text: 'Kesim Bildirimi' },
      { type: 'p', text: 'Kurban kesildiğinde sistem otomatik olarak hayırsevere WhatsApp veya SMS bildirimi gönderir. Dilediğinizde fotoğraf veya konum da ekleyebilirsiniz. İbadetin tamamlandığı haberini anında almak, hayırseverin gönlünü huzura kavuşturur.' },
      { type: 'h2', text: 'Kesimhane ve Lojistik Koordinasyonu' },
      { type: 'p', text: 'Farklı kesimhanelere bölüştürülmüş hisseleri panelden takip edebilirsiniz. Hangi kesimhanede kaç kurban var, hangi hayırseverlerin hissesi kesildi, etten kimin pay alacağı — tüm bu bilgiler ekranda görünür ve dışa aktarılabilir.' },
      { type: 'h2', text: 'Kurban Bayramından Önce Hazırlanmak' },
      { type: 'p', text: 'Hisse taleplerini bayramdan 2-3 ay önce almaya başlamak hem nakit akışını düzenler hem de kesimhane planlamasını kolaylaştırır. Son güne kadar online hisse talebi alınabilir; hiçbir hayırsever geri çevrilmez.' },
      { type: 'p', text: 'Pekin Teknoloji kurban organizasyon modülü, hisse talebinden kesim bildirimine tüm süreci kapsar. Kurban bayramına yetişmeniz için kurulum birkaç gün sürer.' },
    ],
  },
  {
    slug: 'dernek-yazilimi',
    tag: 'Dernek', color: '#7c3aed',
    title: 'Dernek Yazılımı Nedir? Hangi Özelliklere Bakılmalı?',
    desc: 'Hayırsever yönetiminden sadaka takibine, etkinlikten raporlamaya — doğru dernek yazılımı nasıl seçilir?',
    readTime: '6 dk',
    img: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=600&q=80',
    content: [
      { type: 'p', text: 'Dernek ve vakıflar her geçen yıl daha fazla hayırseveri ve hayır projesini yönetmek zorunda kalıyor: binlerce sadaka kaydı, onlarca kampanya, yüzlerce etkinlik katılımcısı. Bu sorumluluğu Excel tablolarında taşımak hataya ve zaman kaybına açıktır. Doğru dernek yazılımı bu karmaşıklığı tek bir platforma taşır ve emaneti koruma altına alır.' },
      { type: 'h2', text: 'Dernek Yazılımı Ne İşe Yarar?' },
      { type: 'p', text: 'Dernek yazılımı, sivil toplum kuruluşlarının hayır faaliyetlerini dijital ortamda düzenli ve şeffaf biçimde yürütmesini sağlar. Hayırsever kayıtları, sadaka geçmişi, kampanya yönetimi, etkinlik organizasyonu, gönüllü koordinasyonu ve raporlama temel çözüm alanlarıdır. İyi bir dernek yazılımı web sitesiyle entegre çalışır: hayırsever siteden sadakasını verir, veri otomatik olarak panele düşer.' },
      { type: 'h2', text: 'Hayırsever Yönetimi (CRM)' },
      { type: 'p', text: 'Her hayırseverin tam profiline — iletişim bilgileri, sadaka geçmişi, katıldığı projeler, iletişim rızaları — tek ekrandan ulaşabilmek, derneğin emanetini hakkıyla yerine getirmesini sağlar. Hayırseverleri sınıflayabilmek (yeni, düzenli, sessiz kalan) ise doğru zamanda doğru mesajı iletmenizi mümkün kılar.' },
      { type: 'h2', text: 'Kampanya ve Sadaka Yönetimi' },
      { type: 'p', text: 'Farklı hayır projeleri için ayrı kampanya sayfaları oluşturabilmek, her projenin hedef ve ilerleme durumunu anlık görebilmek temel beklentidir. Otomatik makbuz düzenleme ve yasal raporlama ise her dernek yazılımının olmazsa olmazıdır.' },
      { type: 'h2', text: 'WhatsApp ve E-posta Bildirimleri' },
      { type: 'p', text: 'Türkiye\'de hayırseverle iletişimin en etkili kanalı WhatsApp\'tır. Sadaka alındığında, proje tamamlandığında veya mübarek günlerde otomatik mesaj gönderebilen bir yazılım, ekip yorulmadan hayırsever bağını canlı tutar.' },
      { type: 'h2', text: 'Raporlama ve Şeffaflık' },
      { type: 'p', text: 'Yönetim kuruluna, denetçilere ve hayırseverlere sunulacak raporları her ay manuel hazırlamak vakit çalar. İyi bir dernek yazılımı proje bazlı, dönemsel ve hayırsever bazlı raporları tek tıkla PDF veya Excel olarak verir.' },
      { type: 'h2', text: 'Bulut Tabanlı mı, Yerel Kurulum mu?' },
      { type: 'p', text: 'Bulut tabanlı dernek yazılımları güncellemeleri otomatik alır, sunucu bakımı gerektirmez ve internet olan her yerden erişilebilir. Küçük ve orta ölçekli dernekler için aylık sabit ücretli model tüm maliyetleri öngörülebilir kılar.' },
      { type: 'p', text: 'Pekin Teknoloji dernek yazılımı; hayırsever CRM, sadaka kampanyası yönetimi, WhatsApp bildirimleri, otomatik makbuz ve gelişmiş raporlamayı tek platformda sunar. Aylık sabit ücret, aynı gün kurulum.' },
    ],
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Aynı anda farklı ülkelerde birden fazla kuyu projesi yürüten dernekler, her projeyi ayrı kampanya sayfasında yönetir. Panel üzerinden hangi projeye ne kadar sadaka toplandığını, hangi hayırseverin hangi kuyuya katkı verdiğini tek ekrandan görmek bu sorumluluğu doğru taşımayı kolaylaştırır.' },
      { type: 'h2', text: 'Dijital Görünürlük ve Yeni Hayırseverlere Ulaşmak' },
      { type: 'p', text: '"Afrika\'da su kuyusu", "su kuyusu sadakası", "su kuyusu yaptır" gibi aramalarda derneğinizin proje sayfaları organik trafik alabilir. Her projenin kendine özgü URL\'si ve açıklayıcı içeriği olduğunda yeni hayırseverler sizi Google üzerinden bulur.' },
      { type: 'p', text: 'Pekin Teknoloji su kuyusu sadaka platformu; proje bazlı kampanya sayfaları, anlık ilerleme takibi, otomatik tamamlanma bildirimi ve çoklu proje yönetimini bir arada sunar.' },
    ],
  },
];
          ...
          >
            ...
            <div className="home-hero-btns">
              <Link to="/dernekler" className="btn-hero btn-hero--ngo">
                <span className="btn-hero-emoji" style={{transform:'translateY(-3px)'}}>🏛</span> Dernek & STK Platformu <ArrowRight size={16} />
              </Link>
              <Link to="/eticaret" className="btn-hero btn-hero--ec">
                <span className="btn-hero-emoji" style={{transform:'translateY(-1px)'}}>🛒</span> E-Ticaret Mağazası <ArrowRight size={16} />
              </Link>
            </div>
        ...
        <div className="footer-inner">
          ...
          <div className="footer-bottom">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/pekin_teknoloji" target="_blank" rel="noreferrer" aria-label="Instagram">
              ...
              <a href="https://tr.linkedin.com/company/pekin-teknoloji" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="social-link--linkedin">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
