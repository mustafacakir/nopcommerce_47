...
namespace Nop.Web.Controllers
{
    public class QuickStartController : BasePublicController
    {
        ...
        {
            // Zaten login olmuş kullanıcı token olmadan da görebilir
            ...
            // Token ile customer ID'yi bul (tek DB sorgusu)
            ...
            // Token geçerli — login yap, token'ı temizle
...
.step-icon-3 {{ background: #dcfce7; }}
.step-icon-4 {{ background: #dbeafe; }}
.step-text {{ flex: 1; }}
.step-label {{
  font-size: 0.9rem;
  font-weight: 600;
...
<div class=""main"">
  ...
  <div class=""hero"">
    ...
    <div class=""hero-body"">
      ...
      <div class=""steps"">
        <a href=""{au}/setting/generalcommon"" class=""step"">
          <div class=""step-icon step-icon-1"">🏪</div>
          <div class=""step-text"">
            <div class=""step-label"">Mağaza bilgilerini tamamla</div>
            <div class=""step-desc"">Logo, iletişim bilgileri ve mağaza ayarları</div>
          </div>
          <span class=""step-arrow"">›</span>
        </a>
        <a href=""{au}/product/create"" class=""step"">
        ...
        <a href=""{au}/payment/methods"" class=""step"">
          <div class=""step-icon step-icon-3"">💳</div>
          <div class=""step-text"">
            <div class=""step-label"">Ödeme yöntemini aktifleştir</div>
            <div class=""step-desc"">iyzipay entegrasyonunu yapılandır</div>
          </div>
          <span class=""step-arrow"">›</span>
        </a>
        <a href=""{au}/shipping/methods"" class=""step"">
          <div class=""step-icon step-icon-4"">🚚</div>
          <div class=""step-text"">
            <div class=""step-label"">Kargo ayarlarını yap</div>
            <div class=""step-desc"">Teslimat bölgesi ve ücret hesaplama</div>
          </div>
          <span class=""step-arrow"">›</span>
        </a>
      </div>
